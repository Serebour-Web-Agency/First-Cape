...
// Auto-initialize if FIRSTCAPE_CONFIG is already loaded
if (typeof FIRSTCAPE_CONFIG !== 'undefined' && FIRSTCAPE_CONFIG.airtable) {
  airtableClient.init(FIRSTCAPE_CONFIG.airtable);
  console.log('[AirtableClient] Auto-initialized from FIRSTCAPE_CONFIG');
} else {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    if (typeof FIRSTCAPE_CONFIG !== 'undefined' && FIRSTCAPE_CONFIG.airtable) {
      ...
      console.warn('[AirtableClient] FIRSTCAPE_CONFIG not found. Initialize manually with airtableClient.init(config)');
    }
  });
}
